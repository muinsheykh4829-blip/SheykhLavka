...
@section('page-title', 'Добавить новую категорию')
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="icon_file" class="form-label">Загрузить иконку</label>
                        <input type="file" 
...
function previewUploadedImage(input) {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            preview.innerHTML = `
                <div class="mt-2">
                    <label class="form-label">Предварительный просмотр:</label><br>
